...
as bool?,oss: freezed == oss ? _self.oss : oss // ignore: cast_nullable_to_non_nullable
as OssMode?,supplyCode: freezed == supplyCode ? _self.supplyCode : supplyCode // ignore: cast_nullable_to_non_nullable
as String?,vatPriceMode: freezed == vatPriceMode ? _self.vatPriceMode : vatPriceMode // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Generator() when $default != null:
return $default(_that.id,_that.customId,_that.name,_that.proforma,_that.paypal,_that.gopay,_that.taxDateAtEndOfLastMonth,_that.due,_that.subjectId,_that.numberFormatId,_that.note,_that.footerNote,_that.bankAccountId,_that.ibanVisibility,_that.tags,_that.orderNumber,_that.currency,_that.exchangeRate,_that.paymentMethod,_that.customPaymentMethod,_that.language,_that.transferredTaxLiability,_that.oss,_that.supplyCode,_that.vatPriceMode,_that.roundTotal,_that.subtotal,_that.total,_that.nativeSubtotal,_that.nativeTotal,_that.roundingAdjustment,_that.legacyBankDetails,_that.htmlUrl,_that.url,_that.subjectUrl,_that.lines,_that.createdAt,_that.updatedAt);case _:
  return orElse();
